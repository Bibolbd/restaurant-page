...
function content() {
    ...
    heading.textContent = 'A BOWL OF LOVE FROM<br>JAPANESE CUISINE<br>FOR YOU'
    paragraph.textContent = 'It is a long established fact that a reader will be distracted by the readable<br />content of a page when looking at its layout. The point of using Lorem<br />Ipsum is that it has a more-or-less no'
    image.src = ramen
